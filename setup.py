...
PREFIX = 'trytonspain'
MODULE2PREFIX = {'account_financial_statement': 'trytonspain'}
OWNER = {
    'nantic':'NaN-tic',
    'trytonzz':'nanticzz',
}
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-account_financial_statement_es',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-account_financial_statement_es'
    },
    classifiers=[
